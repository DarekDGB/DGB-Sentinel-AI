...
This document defines the first DGB Sentinel AI Shield v4 component-verdict contract.
...
The V4.5C DGB Sentinel AI pilot uses deterministic TEST-ONLY signatures for contract and CI locking.
