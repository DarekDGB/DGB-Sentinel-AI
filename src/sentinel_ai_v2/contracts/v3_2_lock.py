...
COMPONENT_NAME = 'DGB Sentinel AI'
SUPPORTED_REASON_IDS = ('SNTL_OK_TELEMETRY_ALLOW', 'SNTL_ESCALATE_THREAT_REVIEW', 'SNTL_DENY_THREAT_DETECTED', 'SNTL_ERROR_AI_OUTPUT_UNTRUSTED', 'SNTL_ERROR_CONTEXT_HASH_MISMATCH')
SUPPORTED_EVIDENCE_FAMILIES = ('telemetry', 'monitor_signal', 'threat_observation', 'adaptive_core_bridge_event')
