...
from sentinel_ai_v2.v4 import COMPONENT_ID, COMPONENT_ROLE, CONTRACT_VERSION, VERDICT_SCHEMA_VERSION
from sentinel_ai_v2.v4.crypto_verdict import (
...
from sentinel_ai_v2.v4.trust_profile import CLASSICAL_ED25519, FN_DSA, ML_DSA, build_test_trust_profile
...
def unsigned_payload() -> dict:
    return build_unsigned_crypto_verdict_payload(
        ...
        metadata={"pilot": "sentinel-ai-v4", "nested": {"safe": True}},
...
def test_sentinel_ai_v4_signed_component_verdict_contract_validates() -> None:
    payload = unsigned_payload()
