...
from sentinel_ai_v2.contracts.v3_2_lock import SUPPORTED_EVIDENCE_FAMILIES, SUPPORTED_REASON_IDS
from sentinel_ai_v2.v4.crypto_verdict import build_signed_crypto_verdict_envelope, build_unsigned_crypto_verdict_payload, validate_crypto_verdict_envelope
from sentinel_ai_v2.v4.signing import parse_json_no_duplicate_keys, verify_test_only_signature, to_canonical_json
from sentinel_ai_v2.v4.trust_profile import build_test_trust_profile
...
def test_sentinel_ai_v4_expected_context_hash_is_bound() -> None:
...
def test_sentinel_ai_v4_changed_context_after_signing_changes_payload_hash() -> None:
...
def test_sentinel_ai_v4_canonicalization_rejects_ambiguous_payloads() -> None:
...
def test_sentinel_ai_v4_unsigned_payload_builder_fail_closed_guards() -> None:
    base = {
        "request_id": "req-sentinel-ai-v4",
        "context_hash": HASH_A,
        "freshness_nonce": "nonce-sentinel-ai-v4",
    ...
    with pytest.raises(ValueError, match="unsigned Sentinel AI v4 verdict"):
