...
from sentinel_ai_v2.v4.real_crypto_backend import build_real_crypto_signature_input
...
def test_v48h_sentinel_ai_fn_dsa_component_signed_message_draft_profile_kat_is_frozen() -> None:
