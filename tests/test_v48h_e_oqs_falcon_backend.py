...
import sentinel_ai_v2.v4.oqs_falcon_backend as oqs_falcon_module
from sentinel_ai_v2.v4.oqs_falcon_backend import OQS_FALCON_MECHANISM, OqsFalcon1024Backend
from sentinel_ai_v2.v4.signing import COMPONENT_VERDICT_DOMAIN as DOMAIN_TAG
from sentinel_ai_v2.v4.trust_profile import FIPS206_DRAFT_FALCON1024_PROFILE
from sentinel_ai_v2.v4 import COMPONENT_ROLE
from sentinel_ai_v2.v4.real_crypto_backend import (
    SentinelAiV4RealCryptoBackendError as BackendError,
    SentinelAiV4RealCryptoBackendUnavailable as BackendUnavailable,
...
PAYLOAD_HASH = "e" * 64
PUBLIC_KEY_BYTES = b'shield-v48h-e-sentinel-falcon-public-key'
PRIVATE_KEY_BYTES = PUBLIC_KEY_BYTES
PRIVATE_KEY_REFERENCE = "hsm://sentinel-ai/fn-dsa-falcon1024/v1"
